...
/**
 * Class to read data related to Group Milestones
 */
@Component
public class GroupMilestonesItemReader implements ItemReader<Document> {
    ...
    public Document read() throws Exception {
        ...
        if (listDocuments == null) {
            gitlabRepository.deleteGroupMilestones();
        ...
        while (listDocuments.isEmpty()) {
            ...
            String groupId = "" + lstGetGroups.get(groupIndex).getInteger("id");
