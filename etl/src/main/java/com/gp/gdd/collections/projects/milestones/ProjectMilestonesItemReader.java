...
/**
 * Class to read data related to project milestones
 */
@Component
public class ProjectMilestonesItemReader implements ItemReader<Document> {
    ...
    public Document read() throws Exception {
        ...
        if (listDocuments == null) {
            gitlabRepository.deleteProjectMilestones();
        ...
        while (listDocuments.isEmpty()) {
            ...
            String projectId = "" + lstGetProjects.get(projectIndex).getInteger("id");
